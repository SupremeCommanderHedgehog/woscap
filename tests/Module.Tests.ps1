...
Describe 'woscap module' {
    ...
    It 'exports only the intended public commands' {
        (Get-Command -Module woscap).Name | Sort-Object | Should -Be @('Export-WoscapIntegration','Export-WoscapResult','Get-WoscapBenchmark','Get-WoscapIntegration','Import-WoscapIntegration','Invoke-WoscapIntegration','Invoke-WoscapRemediation','Invoke-WoscapScan','Remove-WoscapBenchmark','Save-WoscapStigContent','Show-WoscapGui','Update-WoscapBenchmark')
    }
}
